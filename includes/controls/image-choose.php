...
class Topppa_Image_Choose extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		...
		// styles
		wp_register_style( 'topppa-css-image-choose-control', TOPPPA_INC_URL . 'controls/assets/css/topppa-imagechoose.css', array(), '1.0.0' );
		wp_enqueue_style( 'topppa-css-image-choose-control' );

		// script
		wp_register_script( 'topppa-js-image-choose-control', TOPPPA_INC_URL . 'controls/assets/js/topppa-imagechoose.js',  $dependencies, '1.0.0', true);
		wp_enqueue_script( 'topppa-js-image-choose-control' );
	}
