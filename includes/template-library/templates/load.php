...
use \TopperPack\Includes\Templates_Library\TOPPPA_Templates_Init as Init;
...
class TOPPPA_Templates_Load {
    ...
    public static function get_library() {
        if (is_null(self::$library_data)) {
            self::$library_data = new TOPPPA_Templates_Api();
        }
        return self::$library_data;
    }

    public function register_ajax_actions(Ajax $ajax) {
        $ajax->register_ajax_action('get_topppa_library_data', function ($data) {
