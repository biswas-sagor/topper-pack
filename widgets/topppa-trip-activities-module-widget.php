 ...
 * @since 1.0.0
 */
class TOPPPA_Trip_Activities_Module_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'trip-activities-module-widget';
    }
    ...
    public function get_title() {
        return TOPPPA_EPWB . esc_html__('Trip Activities Module', 'topper-pack');
    }
    ...
    public function get_keywords() {
        return ['topppa', 'widget', 'Trip Activities Module', 'travel', 'topperpack'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .topppa-trip-v2-button .topppa-btn .btn-icon::before',
                'condition' => [
                    'topppa_btn_styles' => 'style_eight'
                ]
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .topppa-slider-arrow-wrp .topppa-arrow-next.button' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .topppa-slider-arrow-wrp .topppa-arrow-next.button svg path' => 'fill: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'topper-pack'),
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .topppa-slider-arrow-wrp .topppa-arrow-next.button',
                'fields_options' => [
                    'background' => [
                        'label' => esc_html__('Background', 'topper-pack'),
                        'default' => 'classic',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .topppa-slider-arrow-wrp .topppa-arrow-next.button:hover' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .topppa-slider-arrow-wrp .topppa-arrow-next.button:hover svg path' => 'fill: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'topper-pack'),
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .topppa-slider-arrow-wrp .topppa-arrow-next.button:hover',
                'fields_options' => [
                    'background' => [
                        'label' => esc_html__('Background', 'topper-pack'),
                        'default' => 'classic',
