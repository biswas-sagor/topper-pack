 ...
 * @since 1.0.0
 */
class TOPPPA_Trip_Activities_Taxonomy_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'trip-activities-taxonomy';
    }
    ...
    public function get_title() {
        return TOPPPA_EPWB . esc_html__('Trip Activities Taxonomy', 'topper-pack');
    }
    ...
    public function get_keywords() {
        return ['topppa', 'widget', 'Trip Activities Taxonomy', 'travel', 'topperpack'];
    }
