 ...
 * @since 1.0.0
 */
class TOPPPA_Trip_Destination_Module_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'trip-destination-module-widget';
    }
    ...
    public function get_title() {
        return TOPPPA_EPWB . esc_html__('Trip Destination Module', 'topper-pack');
    }
    ...
    public function get_keywords() {
        return ['topppa', 'widget', 'Trip Destination Module', 'travel', 'topperpack'];
    }
