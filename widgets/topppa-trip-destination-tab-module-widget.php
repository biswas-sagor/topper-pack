 ...
 * @since 1.0.0
 */
class TOPPPA_Trip_Destination_Tab_Module_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return TOPPPA_EPWB . esc_html__('Trip Destination Tab V1', 'topper-pack');
    }
    ...
    public function get_keywords() {
        return ['topppa', 'widget', 'Trip Destination Tab', 'travel', 'topperpack'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'category_item' => esc_html__('Category Item', 'topper-pack'),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'select_thumbnail',
            [
                'label' => esc_html__('Select Thumbnail', 'topper-pack'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'thumbnail',
                'options' => [
                    'thumbnail' => esc_html__('Thumbnail', 'topper-pack'),
                    'gallery' => esc_html__('Gallery', 'topper-pack'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item' => 'backdrop-filter: blur({{SIZE}}{{UNIT}});',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-content-area' => 'backdrop-filter: blur({{SIZE}}{{UNIT}});',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'topper-pack'),
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .topppa-trip-item .topppa-trip-content-area',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-content-area' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'topper-pack'),
                'types' => ['gradient'],
                'selector' => '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .swiper-slide:after,{{WRAPPER}} .topppa-trip-item .topppa-trip-image.thumbnail:after',
                'fields_options' => [
                    'background' => [
                        'label' => esc_html__('Background', 'topper-pack'),
                        'default' => 'classic',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image' => 'height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image img' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'default' => [
                    'unit' => 'px',
                    'size' => 250,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Pagination Styles', 'topper-pack'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .trip-destination-gallery-pagination' => 'gap: {{SIZE}}{{UNIT}};',
                ],
                'default' => [
                    'unit' => 'px',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .trip-destination-gallery-pagination' => 'justify-content: {{VALUE}};',
                ],
                'condition' => [
                    'select_thumbnail' => 'gallery',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .trip-destination-gallery-pagination span.swiper-pagination-bullet' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'select_thumbnail' => 'gallery',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .trip-destination-gallery-pagination span.swiper-pagination-bullet' => 'Width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'select_thumbnail' => 'gallery',
                ],
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'gallery_dote_background',
                'label' => esc_html__('Background', 'topper-pack'),
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .trip-destination-gallery-pagination span',
                'fields_options' => [
                    'background' => [
                        'label' => esc_html__('Background', 'topper-pack'),
                        'default' => 'classic',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .trip-destination-gallery-pagination span.swiper-pagination-bullet-active' => 'width: {{SIZE}}{{UNIT}} !important;',
                ],
                'condition' => [
                    'select_thumbnail' => 'gallery',
                ],
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'gallery_active_dote_background',
                'label' => esc_html__('Background', 'topper-pack'),
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .trip-destination-gallery-pagination .swiper-pagination-bullet-active',
                'fields_options' => [
                    'background' => [
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
            [
                'name' => 'gallery_dote_border',
                'selector' => '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .trip-destination-gallery-pagination span.swiper-pagination-bullet',
                'condition' => [
                    'select_thumbnail' => 'gallery',
                ],
            ]
        ...
        $this->add_responsive_control(
            'gallery_dote_border_radius',
            [
                'label' => esc_html__('Border Radius', 'topper-pack'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .trip-destination-gallery-pagination span.swiper-pagination-bullet' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'select_thumbnail' => 'gallery',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .trip-destination-gallery-pagination' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'select_thumbnail' => 'gallery',
                ],
        ...
        $this->start_controls_section(
            'Destinations_styles',
            [
                'label' => esc_html__('Destinations Style', 'topper-pack'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_tabs(
            'Destinations_style_tabs'
        );
        $this->start_controls_tab(
            'destinations_icon_style_tab',
            [
                'label' => esc_html__('Icon', 'topper-pack'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-location' => 'backdrop-filter: blur({{SIZE}}{{UNIT}});',
                ],
            ]
        );
        $this->add_responsive_control(
            'destinations_icon_width',
            [
                'label' => esc_html__('Width', 'topper-pack'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-location' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'destinations_icon_height',
            [
                'label' => esc_html__('Height', 'topper-pack'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-location' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
            [
                'name' => 'destinations_icon_border',
                'label' => esc_html__('Border', 'topper-pack'),
                'selector' => '{{WRAPPER}} .topppa-trip-item .topppa-trip-location',
            ]
        );
        $this->add_responsive_control(
            'destinations_icon_radius',
            [
                'label' => esc_html__('Border Radius', 'topper-pack'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-location' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        $this->start_controls_tab(
            'destinations_text_style_tab',
            [
                'label' => esc_html__('Text', 'topper-pack'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .topppa-trip-location span',
            ]
        );
        $this->add_responsive_control(
            'destinations_color',
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .topppa-trip-location span a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            'destinations_hover_color',
            [
                'label' => esc_html__('Hover Color', 'topper-pack'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .topppa-trip-location span a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
            [
                'name' => 'destinations_border',
                'label' => esc_html__('Border', 'topper-pack'),
                'selector' => '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .topppa-trip-location span',
            ]
        );
        $this->add_responsive_control(
            'destinations__radius',
            [
                'label' => esc_html__('Border Radius', 'topper-pack'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .topppa-trip-location span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'destinations_text_padding',
            [
                'label' => esc_html__('Padding', 'topper-pack'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-item .topppa-trip-image .topppa-trip-location span ' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
    ...
    protected function render() {
        ...
        if ($settings["filter_item"] === 'category_item' && !empty($item_cats)) {
        ...
        $thumbnail = isset($select_thumbnail[$settings['select_thumbnail']]) ? $select_thumbnail[$settings['select_thumbnail']] : '';
?>
        <div class="topppa-trip-tab-wrapper">
            <?php if ($settings["filter_item"] === 'category_item' && $settings["enable_top_menu"] === 'yes'): ?>
                <div class="container">
                    <div class="topppa-trip-tab-menu-wrap">
                        <ul class="nav topppa-trip-tab-menu" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link topppa-trip-tab-menu-btn active" data-bs-toggle="tab"
                                    data-bs-target="#all-<?php echo esc_attr($unique); ?>" type="button" role="tab"
                                    aria-selected="true">
                            ...
                            ?>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link topppa-trip-tab-menu-btn" data-bs-toggle="tab"
                                                data-bs-target="#<?php echo esc_attr($term->slug); ?>" type="button" role="tab">
            ...
            <div class="tab-content" id="myTabContent-<?php echo esc_attr($unique); ?>">
                ...
                <div class="tab-pane fade show active" id="all-<?php echo esc_attr($unique); ?>">
                    <div class="tab-container">
                        <div class="<?php echo esc_attr(
                                        ($settings['select_layout'] === 'slider' ? 'swiper topppa-swiper-slider' : 'no-slide') . ' topppa-swiper-slider-' . $unique
                            ...
                            <div
                                class="<?php echo esc_attr($settings['select_layout'] === 'slider' ? 'swiper-wrapper' : 'row'); ?>">
                                ...
                                ?>
                                    <div
                                        class="<?php echo esc_attr($settings['select_layout'] === 'slider' ? 'swiper-slide' : $column); ?>">
                                        ...
                                        <div class="topppa-trip-item">
                                            ...
                                            if (is_array($gallery_meta)) {
                                                foreach ($gallery_meta as $key => $value) {
                                                    if (is_int($key)) {
                                                        $gallery_images[] = absint($value);
                                                    }
                                                }
                                            }
                                            ?>
                                            <div
                                                class="topppa-trip-image <?php echo esc_attr($thumbnail); ?>">
                                                <?php if ($settings['select_thumbnail'] === 'gallery'): ?>

                                                    <?php if (!empty($gallery_images)): ?>

                                                        <!-- INNER GALLERY SWIPER -->
                                                        <div class="swiper topppa-trip-gallery-slider">
                                                            ...
                                                            <div class="trip-destination-gallery-pagination"> </div>

                                                        </div>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <?php if ($settings['select_thumbnail'] === 'thumbnail'): ?>
                                                    <?php the_post_thumbnail('full'); ?>

                                                <?php endif; ?>

                                                <?php if ($settings['enable_discount_value'] === 'yes' && !empty($discount_html)): ?>
                                            ...
                                            <div class="topppa-trip-content-area">
                                                ...
                                                <?php if ($settings['enable_description'] == 'yes'): ?>
                                                    <div class="topppa-trip-description">
                                                        <?php echo wp_kses_post(wp_trim_words(get_the_content(), $settings['dec_length'])); ?>
                                                    </div>
                                                <?php endif; ?>
                                                <div class="topppa-trip-buttom-area">
                                                    <?php if ($settings['enable_price'] == 'yes'): ?>
                                                        <div class="topppa-trip-price-holder">
                                                            ...
                                                            <div class="topppa-trip-all-fees"><?php echo esc_html('Including all fees.'); ?> </div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <?php if ($settings['enable_button'] === 'yes'): ?>
                                                        <div
                                                            class="topppa-btn-wrapper topppa-trip-button <?php echo esc_attr($btn_class); ?>">
                        ...
                        <?php if ($settings['enable_dote'] === 'yes'): ?>
                            <div class="topppa-dote-pagination topppa-topppa-dote-pagination-<?php echo esc_attr($unique); ?>">
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if ($settings['enable_arrow'] === 'yes' && $settings['select_layout'] === 'slider'): ?>
                            <div class="trip-slider-arrow <?php echo esc_attr($arrow); ?>">
                                <?php if ($settings['style_arrow_type'] === 'text'): ?>
                                    <div
                                        class="topppa-arrow-prev topppa-brand-logo-button-prev-<?php echo esc_attr($unique); ?> button">
                                        <?php echo esc_html__('Prev', 'topper-pack'); ?>
                                    </div>
                                    <div
                                        class="topppa-arrow-next topppa-brand-logo-button-next-<?php echo esc_attr($unique); ?> button">
                    ...
                    if (!empty($item_cat['cat_name'])):
                        ...
                        if ($term && !is_wp_error($term)):
                            $term_query = new WP_Query([
                                'post_type' => 'trip',
                                'posts_per_page' => $item_cat['display_item_repeater'],
                                'tax_query' => [
                                    [
                                        'taxonomy' => 'destination',
                                        'terms' => $term->term_id,
                ...
                ?>
                            <div class="tab-pane fade" id="<?php echo esc_attr($term->slug); ?>">
                                <div class="tab-container">
                                    <div class="<?php echo esc_attr(($settings['select_layout'] === 'slider' ? 'swiper topppa-swiper-slider' : 'no-slide') . ' topppa-swiper-slider-' . $unique
                                                ); ?>" <?php if ($settings['select_layout'] === 'slider'): ?>
                                        data-slides-per-view="<?php echo esc_attr($settings['slide_show_lagrge_item']); ?>"
                                        data-space-between="<?php echo esc_attr($settings['slider_space_between']['size']); ?>"
                                        data-auto-loop="<?php echo esc_attr($settings['enable_slider_auto_loop']); ?>"
                                            ...
                                            <?php while ($term_query->have_posts()):
                                                ...
                                                <div
                                                    ...
                                                    <div class="topppa-trip-item">
                                                        ...
                                                        // Price Handling for category tab
                                                        $price_html = '';
                                                        $discount_html = '';
                                                        $actual_price_html = '';

                                                        $meta = function_exists('wte_trip_get_trip_rest_metadata') ? wte_trip_get_trip_rest_metadata(get_the_ID()) : null;
                                                        if (isset($meta->price)) {
                                                            $regular_price = $meta->price;
                                                            $sale_price = $meta->has_sale ? $meta->sale_price : $meta->price;
                                                            $discount_percent = $meta->has_sale ? $meta->discount_percent : 0;
                                                        ...
                                                        <div class="topppa-trip-content-area">
                                                            <<?php echo esc_attr($settings['title_tag']); ?> class="topppa-trip-title">
                                                                <a href="<?php the_permalink(); ?>"><?php echo esc_html(wp_trim_words(get_the_title(), $settings['title_length'], '')); ?></a>
                                                            </<?php echo esc_attr($settings['title_tag']); ?>>
                                                            <?php if ($settings['enable_trip_meta'] === 'yes'): ?>
                                                                <div class="topppa-trip-meta">
                                                                    <ul>
