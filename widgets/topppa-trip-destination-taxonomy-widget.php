...
/**
 * Elementor TOPPPA Trip Destination Taxonomy Widget.
 *
 * Elementor widget that displays trip destination taxonomy terms.
 *
 * @since 1.0.0
 */
class TOPPPA_Trip_Destination_Taxonomy_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'trip-destination-taxonomy';
    }
    ...
    public function get_title() {
        return TOPPPA_EPWB . esc_html__('Trip Destination Taxonomy', 'topper-pack');
    }
    ...
    public function get_keywords() {
        return ['topppa', 'widget', 'Trip Destination Taxonomy', 'travel', 'topperpack'];
    }
    ...
    public function get_custom_help_url() {
        return 'https://doc.topperpack.com/docs/trip-widgets/trip-destination-taxonomy/';
    }
    ...
    public function get_custom_image_url() {
        return 'https://topperpack.com/assets/widgets/trip-destination-taxonomy/';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'inner_box_styles',
            [
                'label' => esc_html__('Inner Box Style', 'topper-pack'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                    'select_style!' => ['style_three', 'style_eight'],
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            'style_eight_content_box_padding',
            [
                'label' => esc_html__('Padding', 'topper-pack'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-taxonomy-item .topppa-trip-taxonomy-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'select_style' => ['style_eight'],
                ],
            ]
        );
        ...
        $this->start_controls_tab(
            'style_stitle_tab',
            [
                'label' => esc_html__('Trip Count', 'topper-pack'),
                'condition' => [
                    'enable_trip_counts' => 'yes',
                    'select_style!' => 'style_three',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-taxonomy-stitle' => 'backdrop-filter: blur({{SIZE}}{{UNIT}});',
                ],
                'condition' => [
                    'select_style' => ['style_six', 'style_eight'],
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-slider-arrow .topppa-arrow-next.button' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .service-slider-arrow .topppa-arrow-next.button svg path' => 'fill: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'topper-pack'),
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .service-slider-arrow .topppa-arrow-next.button',
                'fields_options' => [
                    'background' => [
                        'label' => esc_html__('Background', 'topper-pack'),
                        'default' => 'classic',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-slider-arrow .topppa-arrow-next.button:hover' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .service-slider-arrow .topppa-arrow-next.button:hover svg path' => 'fill: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'topper-pack'),
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .service-slider-arrow .topppa-arrow-next.button:hover',
                'fields_options' => [
                    'background' => [
                        'label' => esc_html__('Background', 'topper-pack'),
                        'default' => 'classic',
                        ...
                        <div class="<?php echo esc_attr($settings['enable_slider'] === 'yes' ? 'swiper-slide' : $column); ?>">
                            <div class="topppa-trip-taxonomy-item">
                                ...
                                <div class="topppa-trip-taxonomy-content">
                                    <?php if (
                                        ($settings['select_style'] === 'style_three' || $settings['select_style'] === 'style_eight') && $settings['enable_trip_counts'] === 'yes'
                                    ): ?>
                                    ...
                                    <div class="topppa-trip-taxonomy-content-area">
                                        <?php if (
                                            $settings['select_style'] !== 'style_eight' &&
                                        ...
                                        <?php if ($settings['select_style'] !== 'style_seven'): ?>
                                            <div class="topppa-trip-texonomy-bottom">
                                                ...
                                                <?php if ($settings['enable_button'] === 'yes'): ?>
                                                    <div class="topppa-trip-taxonomy-button">
                                                        <div
                                                            class="topppa-btn-wrapper slider-btn-wrapper <?php echo esc_attr($btn_class); ?>">
                                                            <a href="<?php echo esc_url($term_link); ?>" class="topppa-btn">
                                                                <span class="top-btn-text top-btn-text-v3">
                                                                    <?php echo esc_html($settings['button_text']); ?>
                                                                </span>
