 ...
 * @since 1.0.0
 */
class TOPPPA_Trip_Module_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return TOPPPA_EPWB . esc_html__('Trip Module', 'topper-pack');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Trip Options', 'topper-pack'),
        ...
        $this->add_responsive_control(
            'inner_box_padding',
            [
                'label' => esc_html__('Inner Content Padding', 'topper-pack'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .service-slider-arrow' => 'gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .service-slider-arrow' => 'justify-content: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .service-slider-arrow' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .service-slider-arrow' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
...
?>
        <div class="topppa-trip-item-wrp">
                                ...
                                <div class="topppa-trip-item">
                                    ...
                                    <div class="topppa-trip-content-area">
                                        <<?php echo esc_attr($settings['title_tag']); ?> class="topppa-trip-title">
                                            <a href="<?php the_permalink(); ?>"><?php echo wp_kses_post(wp_trim_words(get_the_title(), $settings['title_length'], '')); ?></a>
                                        ...
                                        <?php if ($settings['enable_description'] == 'yes') : ?>
                                            <div class="topppa-trip-description"> <?php echo wp_kses_post(wp_trim_words(get_the_content(), $settings['dec_length'])); ?></div>
                                        <?php endif; ?>
