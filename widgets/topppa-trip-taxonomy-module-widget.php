 ...
 * @since 1.0.0
 */
class TOPPPA_Trip_Taxonomy_Module_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return TOPPPA_EPWB . esc_html__('Trip Taxonomy Module', 'topper-pack');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'select_taxonomy',
            [
                'label' => esc_html__('Select Taxonomy', 'topper-pack'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-taxonomy-item .topppa-trip-taxonomy-icon' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-taxonomy-item .topppa-trip-taxonomy-icon' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .topppa-trip-taxonomy-item .topppa-trip-taxonomy-icon' => 'backdrop-filter: blur({{SIZE}}{{UNIT}});',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'name'     => 'icon_typo',
                'selector' => '{{WRAPPER}} .topppa-trip-taxonomy-item .topppa-trip-taxonomy-icon',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-taxonomy-item .topppa-trip-taxonomy-icon' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .topppa-trip-taxonomy-item .topppa-trip-taxonomy-icon svg path' => 'fill: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-taxonomy-item .topppa-trip-taxonomy-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-taxonomy-item:hover .topppa-trip-taxonomy-icon' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .topppa-trip-taxonomy-item:hover .topppa-trip-taxonomy-icon svg path' => 'fill: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .topppa-trip-taxonomy-item:hover .topppa-trip-taxonomy-icon',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .topppa-trip-taxonomy-item:hover .topppa-trip-taxonomy-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .topppa-trip-taxonomy-item .topppa-trip-taxonomy-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .topppa-trip-taxonomy-item .topppa-trip-taxonomy-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
                        ...
                        <div class="<?php echo esc_attr($settings['enable_slider'] === 'yes' ? 'swiper-slide' : $column); ?>">
                            <div class="topppa-trip-taxonomy-item">
                                ...
                                <div class="topppa-trip-taxonomy-content">
                                    <?php if ($settings['select_style'] === 'style_three' && $settings['enable_icon'] === 'yes') : ?>
                                        <div class="topppa-trip-taxonomy-icon">
                                    ...
                                    <div class="topppa-trip-taxonomy-content-area">
                                        <?php if ($settings['select_style'] !== 'style_seven') : ?>
                                            <?php if ($settings['select_style'] !== 'style_six') : ?>
