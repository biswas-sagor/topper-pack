 ...
 * @since 1.0.0
 */
class TOPPPA_Trip_Types_Module_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'trip-types-module-widget';
    }
    ...
    public function get_title() {
        return TOPPPA_EPWB . esc_html__('Trip Types Module', 'topper-pack');
    }
