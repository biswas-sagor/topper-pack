 ...
 * @since 1.0.0
 */
class TOPPPA_Trip_Types_Tab_Module_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return TOPPPA_EPWB . esc_html__('Trip Types Tab Module', 'topper-pack');
    }
    ...
    public function get_keywords() {
        return ['topppa', 'widget', 'Trip Types Tab', 'travel', 'topperpack'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'multiple'    => true,
                'options'     => [
                    'trip_types' => esc_html__('Trip Type', 'topper-pack'),
        ...
        if ($settings["filter_item"] === 'catergory_item' && !empty($item_cats)) {
            foreach ($item_cats as $item_cat) {
                if (!empty($item_cat['cat_name'])) {
                    $term = get_term_by('slug', $item_cat['cat_name'], 'trip_types');
                        ...
                        <div class="tab-container">
                            <div class="row">
                                <?php while ($query->have_posts()) : $query->the_post();
                                    $trip_id = get_the_ID();
                                    $location = function_exists('wte_get_the_tax_term_list') ? wte_get_the_tax_term_list($trip_id, 'trip_types', '', ', ', '') : '';
                                                ...
                                                <?php if ($settings['enable_location_meta'] === 'yes') : ?>
                                                    <?php if (!empty($location)) : ?>
                                                        <div class="topppa-trip-location">
                                                            <span> <i aria-hidden="true" class="fas fa-map"></i> </span>
